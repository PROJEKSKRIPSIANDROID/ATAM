...
import 'package:mattendance/Pages/Settings/general_setting_page.dart';
            ...
            Container(
              ...
              child: ClipRRect(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => GeneralSetting()));//authenticationBloc.dispatch(LoggedOut());
                    },
                  )
              ),
            ),
